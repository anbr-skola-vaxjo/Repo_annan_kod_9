...
//Starting Settings
    //word settings
        ...
        public static int nr_staring_keys = 0;
    ...
    //Screen Settings
        ...
        static public bool HD_textures = false;
    ...
    protected override void LoadContent()
    {
        ...
        Door_closed = Content.Load<Texture2D>("Door_Wall");             
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if(_frame == First_frame){
            ...
            if(has_renderd == false){
                ...
                E_types.Add(new EntityTypes(Color.White, new List<Simple_texture_layer>(){new Simple_texture_layer(Entety1,false),new Simple_texture_layer(Entety1_glow,true)},new Vector2(0.6f,1f)));
                

                _Item_Types.Add(new Item_Types(new EntityTypes(Color.White,new List<Simple_texture_layer>(){new Simple_texture_layer(Key,false)},new Vector2(0.5f,0.5f)),true));
                ...
                Door_c = new Material_texture_layer(Entety1,false);
                Door_o = new Material_texture_layer(Door,true);
